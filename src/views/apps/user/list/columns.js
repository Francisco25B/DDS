...
const handleDeleteUser = async (user) => {
  const confirm = await Swal.fire({
    ...
    cancelButtonText: 'Cancelar',
    customClass: {
      confirmButton: 'btn-danger', // Esto aplica una clase CSS personalizada al botón de confirmación
      cancelButton: 'btn-secondary' // También puedes personalizar el botón de cancelación
    }
  })
...
export const columns = [
  ...
  { 
    name: <span><FaUser size={16} className='mr-50' lang="en"/> Nombre</span>,  // Icono en el título
    minWidth: '150px', 
    selector: 'nombre', 
    sortable: true, 
  ...
  { 
    name: <span><FaUser size={16} className='mr-50' data-translate="false"/> Usuario</span>,  // Icono en el título
    minWidth: '150px', 
    selector: 'usuario', 
    sortable: true, 
    translate: "no",
  ...
  {
    name: <span><FaLock size={16} className='mr-50' lang="en"/> Estado</span>,  // Icono en el título
    minWidth: '138px',
    selector: 'status',
    lang: "en",
    sortable: true,
